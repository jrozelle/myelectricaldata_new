...
Tu travailles sur la page `/signup` de l'application MyElectricalData.

## Description de la page

Cette page permet aux **nouveaux utilisateurs de créer un compte** et d'obtenir leurs identifiants API (Client ID et Client Secret).
