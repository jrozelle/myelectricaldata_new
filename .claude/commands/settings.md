...
Tu travailles sur la page `/settings` de l'application MyElectricalData.

## Description de la page

Cette page permet aux utilisateurs de **gérer leurs paramètres de compte** et leurs préférences.

Crée les différents bloc dans l'ordre suivant.
...
- Message à l'utilisateur en mode Toast
