...
Tu travailles sur la page `/faq` de l'application MyElectricalData.

## Description de la page

Cette page affiche la **Foire Aux Questions** (FAQ) pour aider les utilisateurs à comprendre et utiliser l'application.
